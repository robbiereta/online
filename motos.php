...
<div class="btn-group btn-group-lg" role="group" aria-label="Basic example">
  ...
  <a href="https://docs.google.com/spreadsheets/d/1zR6jdNi9q98JevkHq6GVr-nPjujiR6xZtaVNDMoJjJ4/edit?ts=5e7e6899#gid=677452087" type="button" class="btn btn-success">Kurazai</a>
  ...
  <a href="http://localhost/pedidos_new" type="button" class="btn btn-primary">Trimer</a>
  <a href="http://localhost/pedidos_new" type="button" class="btn btn-danger">Masuda</a>
  <a href="http://localhost/pedidos_new" type="button" class="btn btn-warning">VG</a>
</div>
<hr>    
<a type="button" class="btn btn-success" href="http://localhost/pedidos_online"><-- Regresar al inicio</a>
    <!-- Optional JavaScript -->
